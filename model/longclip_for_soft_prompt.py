...
from .model_longclip_soft_prompt import build_model
...
def load_from_clip(name: str, num_classes: int, device: Union[str, torch.device] = "cuda" if torch.cuda.is_available() else "cpu", jit: bool = False, download_root: str = None):
