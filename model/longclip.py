...
def load_from_clip(name: str, device: Union[str, torch.device] = "cuda" if torch.cuda.is_available() else "cpu", jit: bool = False, download_root: str = None):
    ...
    with open(model_path, 'rb') as opened_file:
        ...
        state_dict = torch.load("/data/jwsuh/construction/Zero-shot_Image_Classification/dataset/construction/LongCLIP/checkpoints/longclip-L.pt", map_location="cpu")
    ...
    positional_embedding_res = positional_embedding_pre.clone()
            
    model.positional_embedding = nn.Parameter(positional_embedding_pre, requires_grad=False)
